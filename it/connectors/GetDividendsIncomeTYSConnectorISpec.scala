...
class GetDividendsIncomeTYSConnectorISpec extends PlaySpec with WiremockSpec {

  lazy val connector: GetDividendsIncomeTYSConnector = app.injector.instanceOf[GetDividendsIncomeTYSConnector]
  ...
  " GetDividendsIncomeDataTYSConnector" should {
    ...
    "include internal headers" when {
      ...
      "the host for IF is 'External'" in {
        ...
        val connector = new GetDividendsIncomeTYSConnector(httpClient, appConfig(externalHost))
    ...
    "return an Unprocessable entity resonse" in {
      val responseBody = Json.obj(
