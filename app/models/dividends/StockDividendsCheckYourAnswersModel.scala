...
case class StockDividendsCheckYourAnswersModel(gateway: Option[Boolean] = None,
...
case class EncryptedStockDividendsCheckYourAnswersModel(gateway: Option[EncryptedValue] = None,
